      ...
      <div className="flex-1 flex flex-col min-w-0 relative">
        ...
        <header className="h-[70px] flex-shrink-0 border-b border-white/5 bg-[#1E1E20] flex items-center justify-between px-6 sm:px-8 relative z-10">
          ...
          <div className="flex items-center gap-5">
            ...
            <button onClick={() => setView("list")} className="relative text-zinc-400 hover:text-white transition-colors mr-2 cursor-pointer">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="flex-1 flex overflow-hidden relative">
          ...
          <main className="flex-1 px-6 sm:px-8 py-6 overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:'none'] [scrollbar-width:'none']">
            {/* Page Header */}
            ...
            {view === "list" ? (
              ...
              <div className="max-w-[800px]">
                ...
                <div className="mb-10">
                  ...
                  <div onClick={() => setView("details")} className="bg-[#252527] rounded-[16px] p-4 flex gap-4 items-center cursor-pointer hover:bg-[#2a2a2c] transition-colors border border-transparent hover:border-white/5">
                    <div className="w-[120px] h-[85px] rounded-[12px] overflow-hidden relative flex-shrink-0 bg-[#1a1a1c]">
                ...
                <div>
                  ...
                  <div className="mb-6">
                    ...
                    <div className="bg-[#252527] rounded-[16px] p-4 flex gap-4 items-center border border-transparent hover:border-white/5 transition-colors">
                      <div className="w-[120px] h-[85px] rounded-[12px] overflow-hidden relative flex-shrink-0 bg-[#1a1a1c]">
                      ...
                      <div className="flex flex-col items-end justify-between self-stretch pr-2 py-1">
                        <div className="text-[15px] font-bold text-zinc-300">
